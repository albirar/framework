...
{
    /**
     * Event fired on call a get method. The {@code value} object is the current property value. The visitor is called
     * after get the property, in order to pass the current value to this visitor.
     * 
    ...
    /**
     * Event fired on call a set method. The visitor is called before to set the value, in order to enable value
     * modifications by visitor The {@code value} object is the new property value.
     * 
     * @param name The property name
