 ...
 * @since 2.1.0
 */
public interface ITestModelThirdLevelMixInterfaceClass
{
    int getInt3Property();
    void setInt3Property(int int3Property);

    String getString3Property();
    void setString3Property(String string3Property);
    
    public TestModelSecondLevelMixInterfaceClass getTestModelSecondLevel3Property();
    public void setTestModelSecondLevel3Property(TestModelSecondLevelMixInterfaceClass testModelSecondLevel3Property);
}