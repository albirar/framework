 ...
 * @since 2.1.0
 */
public interface ITestModelSecondLevel
{
    int getInt2Property();
    ...
    ITestModelThirdLevel getThirdLevel2ModelProperty();
    void setThirdLevel2ModelProperty(ITestModelThirdLevel thirdLevel2ModelProperty);
}