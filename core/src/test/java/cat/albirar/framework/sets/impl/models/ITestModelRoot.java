 ...
 * @since 2.1.0
 */
public interface ITestModelRoot
{
    int getIntProperty();
    ...
    ITestModelSecondLevel getSecondLevelModelProperty();
    void setSecondLevelModelProperty(ITestModelSecondLevel secondLevelModelProperty);

    ITestModelThirdLevel getThirdLevelModelProperty();
    void setThirdLevelModelProperty(ITestModelThirdLevel thirdLevelModelProperty);
}