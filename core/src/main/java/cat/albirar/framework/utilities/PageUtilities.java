 ...
 * 
 * "core" is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License
 * as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.
 * 
 * "core" is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty
...
public abstract class PageUtilities
{
     ...
     * 
     * @param origin The origin. If null, a new instance with page one and {@value #PAGE_SIZE} items for page is
     *            created.
